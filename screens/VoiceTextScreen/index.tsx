...
import { TouchableOpacity, ImageBackground, Pressable, View } from "react-native";
import { FadeInDown } from 'react-native-reanimated';
import { Images } from "../../config";
import { BackIcon, Container, DescriptionText, HeaderText, LoadingOverlay, LottieAnimation, MicButton, MicIcon, ResultsContainer, ScrollViewContainer, TransparentOverlay, WordContainer, WordText, WordView } from "./style";
...
export const SpeechTextScreen = ({ navigation, route }) => {
  ...
  const { 
    started, results, selectedIndices, end, loading, 
    modalVisible, selectedWord, translatedWord, _startRecognizing, _destroyRecognizer, 
    selectedWords, saveWordPair, setModalVisible 
    ...
    <ImageBackground source={Images.background} style={{ flex: 1 }} resizeMode="cover">
      ...
      {loading ? (
          ...
          <ModalOcr 
            ...
            onSave={() => saveWordPair(selectedWord, translatedWord, main, target)}
